...
async fn main() -> anyhow::Result<()> {
    ...
    // read.  Inert unless a *_FILE variable is set.  Placement is load-bearing
    // and pinned by file_env::tests::hydrate_is_called_at_the_top_of_main.
    ...
    // Report WHERE each bootstrap secret came from — never what it is.
